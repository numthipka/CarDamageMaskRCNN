...
class Config(object):
	...
	# 20200712 : Numthip edit from resnet101 to be resnet50
    BACKBONE = "resnet101"
    ...
    # 20200730 : Numthip K. Comment RPN_ANCHOR_SCALES = (32, 64, 128, 256, 512) (8, 16, 32, 64, 128)
    ...
    WEIGHT_DECAY = 0.0001 # 20200730 : numthip revise 0.001 to be 0.006
